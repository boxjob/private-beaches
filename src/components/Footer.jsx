      ...
      <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
        ...
        <div className='col-span-2 py-8 md:pt-2'>
          ...
          <form className='flex flex-col sm:flex-row'>
            ...
            <button className='p-2 mb-4 duration-300 rounded-md bg-white text-gray-500 hover:text-white hover:bg-white/10'>Subscribe</button>
          </form>
        </div>
      </div>

      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500 duration-500'>
